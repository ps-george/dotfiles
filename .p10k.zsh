# Generated by Powerlevel10k configuration wizard on 2023-05-11 at 11:22 BST.
...
function prompt_my_aws() {
  # local profile=${AWS_VAULT:-${AWSUME_PROFILE:-${AWS_PROFILE:-$AWS_DEFAULT_PROFILE}}
  local ctx=${OMCTL_CTX}
  [[ -n $ctx ]] || return
  p10k segment -f 208 -i '󰸏' -t ${ctx//\%/%%}
}
